...
$stm=$sql->prepare("select * from db1 where db1.email='".$_SESSION['user']."'");
        ...
        <center><button class="mbtn green" onclick="location.href='update.php'" >Edit</button></center>
    </a>
