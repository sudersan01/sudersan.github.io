...
<div class="form">
  <br/>
  <div class="floating">
 <form  method='POST' action="importing.php" enctype='multipart/form-data'>  
  <input type='file' name='namelist'class="floating__input" name="username" placeholder="Username" >
    <span class="hidden--visually">
      Username</span></label>
 </div>
  <input type="submit" name='submit1' value='submit' class="button"></button>
  </form>	  
